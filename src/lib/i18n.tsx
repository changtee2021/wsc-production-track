...
const dictionaries: Record<Lang, Dict> = {
  ...
  my: {
    ...
    "cat.title": "ကုလားကာအမျိုးအစား",
    "cat.placeholder": "-- အမျိုးအစား ရွေးပါ --",
    ...
    "note.toggle": "ပြဿနာရှိပါသလား? ပြီးဆုံးခြင်းမတိုင်မီ မှတ်ချက်ထည့်ပါ",
    "note.placeholder": "တွေ့ရှိသော ပြဿနာကို ဖော်ပြပါ…",
    "note.addPhoto": "ဓာတ်ပုံ ထည့်ပါ",
    "note.changePhoto": "ဓာတ်ပုံ ပြောင်းပါ",
    "note.uploading": "တင်နေသည်…",
    "note.required": "အလုပ်မပြီးခင် မှတ်ချက် ထည့်ပါ",
