...
import { adminFetchQcSummary } from "@/lib/features/admin.functions";
...
export const Route = createFileRoute("/_protected/qc-summary")({
  head: () => ({ meta: [{ title: "สรุป QC — WSC ProductionTrack" }] }),
  component: QcSummaryPage,
});
...
function QcSummaryPage() {
  const fetchSummary = useServerFn(adminFetchQcSummary);
  ...
  return (
    <div className="p-4 md:p-6 space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-2xl font-bold">สรุป QC</h1>
      </div>
